...
class CharSearchTripodView : LinearLayout {
    ...
    fun setTripodImageText(tripod: com.lostark.loahelper.dto.armorys.Tripod, index:Int, tooltip: com.lostark.loahelper.dto.armorys.tooltips.Tooltip){
        ...
        when(index){
            0->{
                tripodDialogLevel = (tooltip.elements.get("Element_006")?.value as com.lostark.loahelper.dto.armorys.tooltips.TripodSkillCustomData).element0.tier
                tripodDescription = (tooltip.elements.get("Element_006")?.value as com.lostark.loahelper.dto.armorys.tooltips.TripodSkillCustomData).element0.desc
            }
            1->{
                tripodDialogLevel = (tooltip.elements.get("Element_006")?.value as com.lostark.loahelper.dto.armorys.tooltips.TripodSkillCustomData).element1.tier
                tripodDescription = (tooltip.elements.get("Element_006")?.value as com.lostark.loahelper.dto.armorys.tooltips.TripodSkillCustomData).element1.desc
            }
            2->{
                tripodDialogLevel = (tooltip.elements.get("Element_006")?.value as com.lostark.loahelper.dto.armorys.tooltips.TripodSkillCustomData).element2.tier
                tripodDescription = (tooltip.elements.get("Element_006")?.value as com.lostark.loahelper.dto.armorys.tooltips.TripodSkillCustomData).element2.desc
            }
        }
