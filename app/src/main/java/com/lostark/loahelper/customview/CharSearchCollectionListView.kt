...
class CharSearchCollectionListView : LinearLayout {
    ...
    lateinit var collectionList:List<com.lostark.loahelper.dto.armorys.CollectiblePoint>
    lateinit var nonHaveCollectionList:List<com.lostark.loahelper.dto.armorys.CollectiblePoint>
    ...
    fun setListView(collectiblePoints: List<com.lostark.loahelper.dto.armorys.CollectiblePoint>){
